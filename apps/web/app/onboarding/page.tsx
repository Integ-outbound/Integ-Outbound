...
import { Checklist, Panel, StatGrid } from '@/components/cards';
...
export default async function OnboardingPage({
  ...
  return (
    <Shell
      ...
      eyebrow="Checklist"
      description="This flow is limited to profile setup, mailbox connection, and operator visibility."
      aside={
    ...
    >
      ...
      <StatGrid
        items={[
          ...
          { label: 'Send-ready leads', value: status.counts.send_ready }
        ]}
      />
    </Shell>
  );
